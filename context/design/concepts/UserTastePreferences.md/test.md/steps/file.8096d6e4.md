---
timestamp: 'Thu Oct 16 2025 23:40:14 GMT-0400 (Eastern Daylight Time)'
parent: '[[../20251016_234014.26fcfac9.md]]'
content_id: 8096d6e4851b6a67d59c96aa5c2714b7bd3d04339fa66ba4a080232535b6c0b4
---
...
export default class UserTastePreferencesConcept {
  ...
  async removeDislikedDish({ user, dish }: { user: User; dish: Dish }): Promise<Empty | { error: string }> {
    ...
    if (!existingUser.dislikedDishes || !existingUser.dislikedDishes.includes(dish)) {
